    ...
    <div className={`min-h-screen bg-sundial-bg text-sundial-text selection:bg-orange-200 overflow-x-hidden font-sans ${cursorMode !== CursorMode.DEFAULT ? 'cursor-none' : ''}`}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 bg-sundial-bg/90 backdrop-blur-md border-b border-sundial-dark/5 px-6 md:px-12 py-5 flex items-center justify-between transition-all duration-300">
        <div className="flex items-center gap-2 group cursor-pointer">
          <div className="w-7 h-7 rounded-full bg-sundial-dark flex items-center justify-center text-white font-serif italic text-lg shadow-md group-hover:scale-105 transition-transform">S</div>
          <span className="font-serif text-2xl tracking-tight text-sundial-dark">sundial</span>
        </div>
        ...
        <section className="bg-gradient-to-br from-[#FFF5F5] to-white rounded-[3rem] p-8 md:p-16 shadow-sm border border-stone-100 relative overflow-hidden">
             <div className="grid md:grid-cols-2 gap-12 md:gap-24 relative z-10">
                 <div className="flex flex-col justify-center">
                    ...
                    <div>
                       <span className="text-[10px] font-bold tracking-[0.2em] text-gray-400 uppercase mb-4 block">How Sundial Solves It —</span>
                       ...
                       <p className="text-gray-600 text-lg leading-relaxed font-light">
                          Sundial curates a store of trusted metrics, entities and events that gets your entire company on the same page.
                       </p>
                    </div>
                 </div>
             ...
             <div className="mt-16 grid md:grid-cols-2 gap-6">
                 <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 border border-white/60">
                     <p className="text-lg text-sundial-dark font-medium leading-relaxed mb-4">
                        "We trust what's on Sundial more than we trust wading through our own tables"
                     </p>
                 ...
                 <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 flex items-center justify-between group cursor-pointer border border-blue-100/50 hover:border-blue-200 transition-colors">
                     <div>
                        <h4 className="font-serif text-xl text-gray-800 mb-2">How Sundial helped Gamma reach 50M users</h4>
             ...
             <div className="grid md:grid-cols-2 gap-12 md:gap-24 relative z-10">
                 <div className="flex flex-col justify-center order-2 md:order-1">
                    ...
                    <div>
                       ...
                       <p className="text-gray-600 text-lg leading-relaxed font-light">
                          Sundial's team of experts understands your company's context and directs you towards the best analyses for your business goals.
                       </p>
                    </div>
                 </div>
             ...
             <div className="mt-16 grid md:grid-cols-2 gap-6">
                 <div className="bg-[#FAF8F6] rounded-2xl p-8 border border-stone-100">
                     <p className="text-lg text-[#594A42] font-medium leading-relaxed mb-4">
                        "Sundial has transformed our ability to operationalize how we build GenAI consumer products. Incredible team, great product!"
                     </p>
                     <div className="flex items-center gap-3">
                 ...
                 <div className="bg-gradient-to-r from-stone-50 to-orange-50 rounded-2xl p-8 flex items-center justify-between group cursor-pointer border border-orange-100/50 hover:border-orange-200 transition-colors">
                     <div>
                        <h4 className="font-serif text-xl text-gray-800 mb-2">How Sundial helped Character identify growth levers</h4>
             ...
             <div className="flex flex-col items-end justify-between">
                 ...
                 <div className="mt-12 text-right">
                    <div className="flex items-center gap-2 justify-end mb-4 text-sundial-dark">
                        <div className="w-6 h-6 rounded-full bg-sundial-dark text-white flex items-center justify-center font-serif italic text-sm">S</div>
                        <span className="font-serif text-2xl tracking-tight">sundial</span>
                    </div>
                    <p className="text-[10px] text-gray-400">© 2025 Sundial. All Rights Reserved</p>
